...
//Route::post('getOptionGroupeUser', 'TlistGroupeUserController@getOptionGroupeUser')->name('getOptionGroupeUser');
    ...
    Route::get('inbox', 'InboxController@index')->name('Messagerie');
    ...
    Route::get('gestionPerso', 'GestionController@personnelle')->name('Personnelle');
    Route::get('profile', 'ParametreController@profile')->name('Profile');
